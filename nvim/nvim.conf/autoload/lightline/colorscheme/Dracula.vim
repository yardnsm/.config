...
" Original version taken from `itchyny/lightline.vim`
...
let s:p.normal.left = [ [ s:black, s:purple, 'bold' ], [ s:cyan, s:gray ] ]
let s:p.normal.right = [ [ s:black, s:purple ], [ s:white, s:darkblue ] ]
let s:p.inactive.right = [ [ s:black, s:gray ], [ s:white, s:black ] ]
let s:p.inactive.left =  [ [ s:cyan, s:black ], [ s:white, s:black ] ]
let s:p.insert.left = [ [ s:black, s:green, 'bold' ], [ s:cyan, s:gray ] ]
let s:p.replace.left = [ [ s:black, s:red, 'bold' ], [ s:cyan, s:gray ] ]
let s:p.visual.left = [ [ s:black, s:orange, 'bold' ], [ s:cyan, s:gray ] ]
