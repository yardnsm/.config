# Generated by Powerlevel10k configuration wizard on 2020-09-12 at 12:17 IDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=140 #76
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=140 #31
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=140 #103
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=140 #39
  ...
  function my_git_formatter() {
    ...
    res+="${meta}%244F@${VCS_STATUS_COMMIT[1,8]}"
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_SHOW_WITH_PYENV=true #false
  # Separate environment name from Python version only with a space.
  typeset -g POWERLEVEL9K_VIRTUALENV_LEFT_DELIMITER="[venv:"
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=green #37
  # Hide python version if it doesn't come from one of these sources.
  typeset -g POWERLEVEL9K_PYENV_SOURCES=(local) # shell global
  # If set to false, hide python version if it's the same as global:
  # $(pyenv version-name) == $(pyenv global).
  typeset -g POWERLEVEL9K_PYENV_PROMPT_ALWAYS_SHOW=true #false
  ...
  typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='${P9K_PYENV_PYTHON_VERSION}'
  ...
  typeset -g POWERLEVEL9K_RBENV_SOURCES=(local) # shell global
  # If set to false, hide ruby version if it's the same as global:
  # $(rbenv version-name) == $(rbenv global).
  typeset -g POWERLEVEL9K_RBENV_PROMPT_ALWAYS_SHOW=true #false
  # If set to false, hide ruby version if it's equal to "system".
  typeset -g POWERLEVEL9K_RBENV_SHOW_SYSTEM=true
  # Custom icon.
  typeset -g POWERLEVEL9K_RBENV_VISUAL_IDENTIFIER_EXPANSION='rb'
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=verbose #off
